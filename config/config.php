...
|
*/
$config['botToken'] = "6786005362:AAGy2y7Pp8x6L5d8xV8naTc4xxpJdt4uM2M";
...
|
*/
$config['adminID'] = "1300408584 5536168611";
...
$config['db']['username'] =  "sql12654737";
$config['db']['password'] =  "r5EypWfGzi";
$config['db']['database'] =  "sql12654737";
